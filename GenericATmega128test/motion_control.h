...
void mcontrol_set (float lin_vel, float ang_vel);		// задаЄм уставки скорости движени€ и поворота платформы
void mcontrol_get_obj(float *lin_vel, float *ang_vel);	// возвращаем уставки скорости движени€ и поворота платформы
...
#define MCONTROL_PI_Ki		7.0 						// ѕ»-
#define MCONTROL_PI_dT		(MCONTROL_PERIOD/1000.0)	// регул€тора по угловой скорости поворота
