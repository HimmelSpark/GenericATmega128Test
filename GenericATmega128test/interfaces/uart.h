...
/* Служебные функции */
void __uart_tx_routine (void);		// обработчик прерывания для передачи байта
/*void __uart_tx_byte (uint8_t data);	// передача байта с тупым ожиданием*/
void __uart_rx_byte (void);			// обработчик прерывания для приёма байта
/**********************/
