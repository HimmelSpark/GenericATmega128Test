...
{	// Ожидаемые скорости (на основе скоростей вращения двигателей)
...
{	
	...
	{	// При установке этого флага принимаем текущее направление в качестве заданного
		I = 0.0;
...
//		gyro.gZ = 0.0;	// только для отладки
