...
void uart_init (void);
int uart_putc (char c, FILE *stream);	// для стд вывода
...
//void __uart_remote_ctrl (void);		// периодическая обработка буфера поступающих команд
/**********************/
...
#define UART_CMD_SIZE		5	// буква + 3 цифры максимум + символ конца команды
#define UART_CMD_TERM		';'	// символ конца команды
